...
ampList=FileNames["*.txt",{FileNameJoin[{dir, "..", "Temp", "procDepBeta"}]}];
exportFortran = "";
exportFortran = exportFortran <> "double complex function A0toTauPTauMProcDepVC()\n";
...
For[i=1,i<=Length[ampList],i++,
	...
	export = Simplify[(oneloop/.{StandardMatrixElement[_]:>1})/(I*EL*ML*Yuk6/(2*MW*SW))];
...
exportFortran=exportFortran<>"A0toTauPTauMProcDepVC = totalAmplitude\n";
exportFortran=exportFortran<>"end function A0toTauPTauMProcDepVC";
filename = FileNameJoin[{dir, "..", "BuildingBlocks", "ProcessDependentScheme", "A0toTauPTauMProcDepVC.txt"}];
